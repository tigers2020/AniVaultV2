...
에이전트·기여자가 따르는 **절차 요약**이다. 세부 톤·역할 대사는 `.cursor/rules/anivault-persona-dialogue.mdc` 와 [persona/README.md](../persona/README.md)를 본다.
...
1. `.cursor/rules/anivault-root.mdc`  
2. `anivault-architecture.mdc`  
3. 그 외 glob 규칙 (`anivault-qt-gui.mdc` 등)
