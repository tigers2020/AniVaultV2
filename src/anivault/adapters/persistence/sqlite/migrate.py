...
def _migration_005_sql() -> str:
    """005_poster_assets.sql 본문을 패키지 리소스에서 읽는다.
...
def _migration_006_sql() -> str:
    """006_organize_plans.sql 본문을 패키지 리소스에서 읽는다.
...
def _migration_007_sql() -> str:
    """007_resolution_cache.sql 본문을 패키지 리소스에서 읽는다.
